# Dessertstorm - Zeek Starter Theme
...
## How to get started
1. Clone or [download](https://github.com/australiansteve/dessertstorm/archive/master.zip "Download the Dessertstorm Zip") the project onto your `themes` directory `(./wp-content/themes)`
